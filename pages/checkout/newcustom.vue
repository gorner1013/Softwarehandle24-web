...
<template>
  ...
  <div class="max-w-360 m-auto md:mt-6 mt-4 px-5">
    <div
      ...
      v-text="checkoutT('$newCustom.title')"
    />
    ...
    <div class="flex md:mt-6 mt-5 pb-30">
      <div class="shadow-1.5xl flex-1 rounded-2.5 bg-white p-5">
        <div
          ...
          v-text="checkoutT('$newCustom.subTitle')"
        />
        ...
        <div class="mt-10 flex flex-col gap-5">
          ...
          <div class="w-full flex flex-col text-black text-3.5 font-medium">
            <input
              ...
              class="w-full px-5 py-4 border border-solid border-gray-700 bg-white text-black text-3.5"
            />
            <div v-if="!isEmailValid" class="mt-1 text-3 text-red-600">
          ...
          <div class="w-full flex flex-col text-black text-3.5 font-medium">
            <input
              ...
              :placeholder="checkoutT('$create.pwconfirmPwd')"
              type="password"
              class="w-full px-5 py-4 border border-solid border-gray-700 bg-white text-black text-3.5"
            />
            <div
          ...
          <div class="w-full">
            <div class="flex flex-col gap5 bg-gray-200 px-2 py-5">
              <li
                class="text-gray-800 text-3.5"
          ...
          <div
            ...
            v-text="`${checkoutT('$create.fieldMarked')} * ${checkoutT('$create.mandatory')}`"
          />
          <div
        ...
        <div class="md:mt-5 mt-8 flex justify-end">
          ...
          :disabled="terms === false"
            ...
            class="md:w-1/2 w-full py-4 flex justify-center border-none duration-300 hover:opacity-80 items-center rounded-1 bg-primary text-white text-3.5 font-medium cursor-pointer"
            @click="invokeSubmit()"
          >
            <Spinner v-if="loading" />
            <span v-else v-text="checkoutT('$newCustom.subTitle')" />
          </button>
        </div>
      </div>
      <div
